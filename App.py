...
def main():
    ...
    state_option = ['MN', 'MO', 'NE', 'ND', 'SD', 'DE', 'FL', 'GA', 'MD', 'NC', 'SC', 'VA', 'DC', 'WV', 'AL', 'KY',
                    'MS', 'TN', 'AR', 'LA', 'OK', 'TX', 'AZ', 'CO', 'ID', 'MT', 'NV', 'NM', 'UT', 'WY', 'AK', 'CA',
                    'HI', 'OR', 'WA','CT', 'ME', 'MA', 'NH', 'RI', 'VT', 'NJ', 'NY', 'PA', 'IL', 'IN',
                    'MI', 'OH', 'WI', 'IA', 'KS',]
    state_to_region = {
    ...
    # Area Code
    area_code = st.selectbox('Area Code', range(len(area_code_option)), format_func=lambda x: area_code_option[x])
    ...
    message = 'FINAL ANSWER OF PREDICTION WILL SHOWN HERE...'
